...
export function RemoteControlEnhanced({
  ...
  const handleLaunchApp = async (appName: string) => {
    if (!onServiceCall || !appleTvEntityId || pending) return;
    setPending(true);
    try {
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <button
              ...
              className="px-2 py-2.5 rounded-lg font-semibold transition-all flex flex-col items-center gap-1"
              style={{
            ...
            <button
              disabled={pending}
              onClick={() => handleLaunchApp('Netflix')}
              className="px-2 py-2.5 rounded-lg font-semibold transition-all flex flex-col items-center gap-1"
              style={{
